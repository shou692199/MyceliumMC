...
import MyceliumMC.server.remapper.*;
...
public class MyceliumURLClassLoader extends URLClassLoader
{
    ...
    public MyceliumURLClassLoader(final URL[] urls, final ClassLoader parent) {
        super(urls, parent);
    }

    public MyceliumURLClassLoader(final URL[] urls) {
        super(urls);
    }

    public MyceliumURLClassLoader(final URL[] urls, final ClassLoader parent, final URLStreamHandlerFactory factory) {
