package MyceliumMC.server.remapper.target;

import MyceliumMC.server.remapper.MyceliumMCRemapper;
import MyceliumMC.server.remapper.ClassInheritanceProvider;
import MyceliumMC.server.remapper.MappingLoader;
import MyceliumMC.server.remapper.ReflectionTransformer;
...
public class MyceliumClassLoader extends ClassLoader {
    private JarMapping jarMapping;
    private MyceliumMCRemapper remapper;

    {
        ...
        this.remapper = new MyceliumMCRemapper(this.jarMapping);
    }

    protected MyceliumClassLoader() {
        super();
    }

    protected MyceliumClassLoader(ClassLoader parent) {
        super(parent);
    }
