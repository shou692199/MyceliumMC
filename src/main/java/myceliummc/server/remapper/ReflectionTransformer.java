...
public class ReflectionTransformer {
    ...
    public static MyceliumMCRemapper remapper;
    ...
    public static void init() {
        ...
        remapper = new MyceliumMCRemapper(jarMapping);
        ...
        try {
            Class.forName("MyceliumMC.server.remapper.target.MethodHandleMethods");
    ...
    public static byte[] transform(byte[] code) {
        ...
        if (remappedSuperClass != null) {
            if (remappedSuperClass == MyceliumClassLoader.class) RemapRules.addVirtualMethodTarget(node.name + ";defineClass", MyceliumClassLoader.class);
