...
import MyceliumMC.server.remapper.target.MyceliumClassLoader;
import MyceliumMC.server.remapper.target.MyceliumURLClassLoader;
import MyceliumMC.server.remapper.target.MethodHandleMethods;
import MyceliumMC.server.remapper.target.ReflectionMethods;
...
public class RemapRules {
    private static final String NMSPackage = "net.minecraft.server." + MyceliumMC.getNativeVersion();
    ...
    static {
        ...
        remapSuperClass.put("java/net/URLClassLoader", MyceliumURLClassLoader.class);
        remapSuperClass.put("java/lang/ClassLoader", MyceliumClassLoader.class);
    }
