...
public class MappingLoader {
    ...
    private static void initGlobalMapping() {
        try {
            ...
            globalJarMapping.classes.put(org_bukkit_craftbukkit + "/Main", org_bukkit_craftbukkit + "/" + MyceliumMC.getNativeVersion() + "/Main");
            globalJarMapping.classes.put(org_bukkit_craftbukkit + "/Main$1", org_bukkit_craftbukkit + "/" + MyceliumMC.getNativeVersion() + "/Main$1");
            ...
            loadNmsMappings(globalJarMapping, MyceliumMC.getNativeVersion());
