package MyceliumMC.server.command;
...
public class CraftSimpleCommandMap extends SimpleCommandMap {
    ...
    public boolean dispatch(CommandSender sender, String commandLine) throws CommandException {
        ...
        try {
            // MyceliumMC start - if command is a mod command, check permissions and route through vanilla
    ...
    // MyceliumMC start - sets the vanilla console sender
