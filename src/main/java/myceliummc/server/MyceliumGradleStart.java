...
public class MyceliumGradleStart {
    public static void main(String[] args) throws Throwable
    {
        (new MyceliumGradleStart()).launch(args);
    }
    ...
    static final File       SRG_SRG_MCP   = new File(MyceliumGradleStart.class.getClassLoader().getResource("mappings/" + MyceliumMC.getNativeVersion() + "/srg2mcp.srg").getFile());
    ...
    private String[] getArgs()
    {
        ...
        b.append(']');
        MyceliumGradleStart.LOGGER.info("Running with arguments: " + b.toString());
